...
public class AdminPage extends JPanel {
	public AdminPage(JPanel panel) {
		...
		System.out.println(rect); setPreferredSize(rect.getSize());
		Date date= new Date();
		...
		idTextField.setPreferredSize(new Dimension(290, 58));
		...
		JLabel nameLabel = new JLabel("도서명: "); nameLabel.setFont(ft);
		JTextField nameTextField = new JTextField(20);
		nameTextField.setFont(ft);
		namePanel.add(nameLabel);
		namePanel.add(nameTextField);
		add (namePanel);
		JPanel pricePanel = new JPanel(); pricePanel.setBounds (100, 100, 700, 50);
...
okButton.addActionListener(new AbstractAction() { 
	public void actionPerformed (ActionEvent e) { 
		String[] writeBook = new String[7]; writeBook[0] = idTextField.getText(); 
