...
public class MainWindow extends JFrame {
	...
	private void menuIntroduction() {
		...
		JButton bt1 = new JButton("고객 정보 확인하기", new ImageIcon("img/1.png"));
		...
		JButton bt2 = new JButton("장바구니 상품 목록 보기", new ImageIcon("img/2.png"));
		...
		JButton bt3 = new JButton("장바구니 비우기", new ImageIcon("img/3.png"));
		...
		JButton bt4 = new JButton("장바구니에 항목 추가하기",new ImageIcon("img/4.png"));
		bt4.setFont(ft);
		mMenuPanel.add(bt4);
		...
		JButton bt5 = new JButton("장바구니의 항목 수량 줄이기",new ImageIcon("img/5.png"));
		bt5.setFont(ft); 
		mMenuPanel.add(bt5);
		
		JButton bt6= new JButton("장바구니의 항목 삭제하기",new ImageIcon("img/6.png"));
		bt6.setFont(ft);
		mMenuPanel.add(bt6);
		...
		public void actionPerformed (ActionEvent e) {
			...
			mPagePanel.add("장바구니의 항목 삭제하기", new CartItemListPage(mPagePanel,
			mCart));
		
		JButton bt7= new JButton("주문하기",new ImageIcon("img/7.png"));
		bt7.setFont(ft);
		mMenuPanel.add(bt7);
		...
		JButton bt8= new JButton("종료",new ImageIcon("img/8.png"));
		bt8.setFont(ft);
		mMenuPanel.add(bt8);
		...
		JButton bt9= new JButton("관리자",new ImageIcon("img/9.png"));
		bt9.setFont(ft);
		mMenuPanel.add(bt9);
		...
		bt9.addActionListener(new ActionListener() {
			public void actionPerformed (ActionEvent e) {
				AdminLoginDialog adminDialog; JFrame frame = new JFrame();
				adminDialog = new AdminLoginDialog(frame,"관리자 로그인");
				adminDialog.setVisible(true);
				if (adminDialog.isLogin) {
					mPagePanel.removeAll();
					mPagePanel.add("22", new AdminPage(mPagePanel));
					mPagePanel.revalidate();
					mPagePanel.repaint();
				}
			}
	...
	private void menuCartClear(JButton button) {
		...
		if(mCart.mCartCount == 0)
			JOptionPane.showConfirmDialog(button, "장바구니에 항목이 없습니다");
		else {
			mCart.deleteBook();
