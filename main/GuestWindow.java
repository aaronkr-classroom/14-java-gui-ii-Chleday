...
public class GuestWindow extends JFrame {
	...
	private void initContainer(String title, int x , int y, int width, int height) {
		...
		ImageIcon imageIcon = new ImageIcon("img/dog.png");
		...
		JLabel titleLabel = new JLabel("--고객정보를 입력하세요 --");
		...
		JLabel phoneLabel = new JLabel("연락처 : ");  //연락처
		...
		JLabel buttonLabel = new JLabel("쇼핑하기",
				new ImageIcon("img/shop.png"),JLabel.LEFT);  //쇼핑하기
		...
		enterButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(nameField.getText().isEmpty() || phoneField.getText().isEmpty())
					JOptionPane.showMessageDialog(enterButton, message, "고객정보",
